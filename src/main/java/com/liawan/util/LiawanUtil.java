...
public class LiawanUtil {
	...
	public static String buildRss(List<ArticleCustom> articles)throws FeedException{
		 ...
		 if(LiawanConst.OPTIONS.get("blog_name")==null) {
			 channel.setTitle("");
		 }else {
			 channel.setTitle(LiawanConst.OPTIONS.get("blog_name"));
		 }
		 if(LiawanConst.OPTIONS.get("blog_url")==null) {
			 channel.setLink("");
		 }else {
			 channel.setLink(LiawanConst.OPTIONS.get("blog_url"));
		 }
		 if(LiawanConst.OPTIONS.get("blog_url")==null) {
			 channel.setUri("");
		 }else {
			 channel.setUri(LiawanConst.OPTIONS.get("blog_url"));
		 }
		 if(LiawanConst.OPTIONS.get("seo_describe")==null) {
			 channel.setDescription("");
		 }else {
			 channel.setDescription(LiawanConst.OPTIONS.get("seo_describe"));
		 }
		...
		for (int i = 0; i < articles.size(); i++) {
			...
			item.setLink(LiawanConst.OPTIONS.get("blog_url")+"/post/"+articles.get(i).getArticleUrl());
