...
public class Commons {
	...
	public static Map<String,String> social(){
		...
		map.put("weibo", LiawanConst.OPTIONS.get(prefix+"weibo"));
		map.put("zhihu", LiawanConst.OPTIONS.get(prefix+"zhihu"));
		map.put("github", LiawanConst.OPTIONS.get(prefix+"github"));
		map.put("twitter", LiawanConst.OPTIONS.get(prefix+"twitter"));
		if(StrUtil.isNotEmpty(LiawanConst.OPTIONS.get(prefix+"qq"))) {
			map.put("qq", "http://wpa.qq.com/msgrd?v=3&uin="+LiawanConst.OPTIONS.get(prefix+"qq")+"&site=qq&menu=yes");
		}
		if(StrUtil.isNotEmpty(LiawanConst.OPTIONS.get(prefix+"email"))) {
			map.put("email", "mailto:"+LiawanConst.OPTIONS.get(prefix+"email"));
		}
		if("rss_open".equals(LiawanConst.OPTIONS.get(prefix+"rss"))) {
				map.put("rss", LiawanConst.OPTIONS.get("blog_url")+"/index.xml");
		}
		return map;
	}
}
