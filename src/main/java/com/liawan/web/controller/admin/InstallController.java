...
public class InstallController extends BaseController{
	...
	public JsonResult execute(@RequestParam(value = "blogName") String blogName,
		...
		article.setArticleTitle("Hello LiaWan!");
		article.setArticleContentMd("# Hello LiaWan!\n" +
                    "欢迎使用LiaWan进行创作，删除这篇文章后赶紧开始吧。");
		...
		article.setArticleSummary("欢迎使用LiaWan进行创作，删除这篇文章后赶紧开始吧。");
		...
		article.setArticleUrl("hello-liawan");
		...
		LiawanConst.THEME_NAME="pinghsu";
		} catch (Exception e) {
